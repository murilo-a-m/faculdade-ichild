        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)){
                ...
                echo"<div value=$row[id] id='DependentSubmit' class='dados'>";
                    ...
                    echo "<a  href='http://localhost/ichild/src/pages/deleteDependent/delete.php?id=$row[id]'>
                    <svg xmlns='http://www.w3.org/2000/svg' id = 'botaoDependent' fill='red' class='bi bi-trash' viewBox='0 0 16 16'>
