        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)){
                ...
                echo"<div value=$row[id] id='DependentSubmit' class='dados'>";
                    ...
                    <svg xmlns='http://www.w3.org/2000/svg' width='27' height='27' fill='#3ab5df' class='bi bi-pencil-square' viewBox='0 0 16 16'>
                    ...
                    <path d='M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1ZM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118ZM2.5 3h11V2h-11v1Z'/></svg></a>";
                echo'</div>';
                echo'</div>';
            }
        }
